...
from easyship.views import MultilanguageTranslate, SignIn, SignOut, Signup
...
urlpatterns = [
    ...
    path("ship-easy/signin/", view=SignIn.as_view(), name="sign-in"),
    path("ship-easy/signup/", view=Signup.as_view(), name="sign-up"),
    path("ship-easy/signout/", view=SignOut.as_view(), name="sign-out"),
    path(
